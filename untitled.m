...
% Last Modified by GUIDE v2.5 06-May-2021 23:23:26
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
msgbox('TERIMAKASIH SUDAH MENGGUNAKAN APLIKASI BELAJAR PENGOLAHAN CITRA DASAR')
pause(1);
close();
close();
...
% handles    structure with handles and user data (see GUIDATA)
a=getappdata(0,'a');
noisesalt=imnoise(a, 'salt & pepper');
axes(handles.axes2);
imshow(noisesalt);
